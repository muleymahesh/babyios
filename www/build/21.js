...
var Checkout1Page = (function () {
    function Checkout1Page(storage, _cart1, datepipe, restProvider, setting, alert, platform, nav, translate, toast, user, loader, woo, _cart, events, _order, address, navParams, modal) {
        var _this = this;
        ...
        this.restProvider.getTimeslot(this.time_slot)
            .then(function (data) {
            _this.response = data;
            _this.storage.set('timejson', _this.response);
        });
